...
•	Amount — Order sale value in Indian Rupees (INR)

•	Category — Product type (Saree, Kurta, Top, Blouse, Bottom, Set, Ethnic Wear, Western)

•	Status — Order fulfillment status (Delivered / Refunded)

•	Ship-State — Indian state of delivery

•	Gender — Customer gender (Men / Women)

•	Age Group — Customer age segment (Adult / Senior / Teenager)

•	Month — Transaction month (January to December)
